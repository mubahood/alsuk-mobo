...
//   String place_of_birth = "";//malin address
//   String sex = "";
//   String home_address = "";//unit number
//   String current_address = "";//Postal Code
//   String phone_number_1 = "";
//   String phone_number_2 = "";
//   String email = "";
//   String nationality = "";
//   String religion = "";//Country
//   String spouse_name = "";//City
//   String spouse_phone = "";
//   String father_name = "";
//   String father_phone = "";
//   String mother_name = "";
...
//   String status = "";
//
//   static Future<List<LoggedInUserModelOld>> getOnlineItems() async {
//     List<LoggedInUserModelOld> data = [];
//
...
//           LoggedInUserModelOld sub = LoggedInUserModelOld.fromJson(x);
//           try {
//             batch.insert(LoggedInUserModelOld.end_point, sub.toJson(),
...
//   }
//
//   static LoggedInUserModelOld fromJson(dynamic m) {
//     LoggedInUserModelOld obj = LoggedInUserModelOld();
//     if (m == null) {
//       return obj;
//     }
//
...
//
//   static Future<LoggedInUserModelOld> getLoggedInUser() async {
//     LoggedInUserModelOld item = LoggedInUserModelOld();
//
//     print("geting user...");
//     if (!await initTable()) {
...
//         await db.query(LoggedInUserModelOld.end_point);
//
//     List.generate(maps.length, (i) {
//       item = LoggedInUserModelOld.fromJson(maps[i]);
//     });
//     return item;
//   }
//
...
//       LoggedInUserModelOld lu = await LoggedInUserModelOld.getLoggedInUser();
...
//     try {
//       await db.insert(
//         LoggedInUserModelOld.end_point,
//         toJson(),
//         conflictAlgorithm: ConflictAlgorithm.replace,
//       );
//       final prefs = await SharedPreferences.getInstance();
