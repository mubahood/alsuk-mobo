...
import '../../sections/cartItemWidget.dart';
                              ...
                              Expanded(
                                child: FxButton(
                                  ...
                                  child: FxText.titleMedium(
                                    'Pickup',
                                    fontWeight: 800,
                                    color: order.delivery_method == "pickup"
                                        ? Colors.white
                                        : CustomTheme.primary,
                                  ),
                                ),
                              ...
                              Expanded(
                                child: FxButton(
                                  ...
                                  child: FxText.titleMedium(
                                    'Delivery',
                                    fontWeight: 800,
                                    color: order.delivery_method == "delivery"
                                        ? Colors.white
                                        : CustomTheme.primary,
                                  ),
                                ),
                    ...
                    FxButton(
                        ...
                        onPressed: () {
                          if (mainController.userModel.id < 1) {
                            Utils.toast('Please login to continue',
                                color: Colors.red);
                            return;
                          }
                          ...
                          if (order.delivery_method.isEmpty) {
                            Utils.toast('Please select a delivery method',
                                color: Colors.red);
                            return;
                          }
                          ...
                          if (order.delivery_method == 'delivery' &&
                              order.delivery_amount.isEmpty) {
                            Utils.toast('Please select a delivery address',
                                color: Colors.red);
                            return;
                          }
