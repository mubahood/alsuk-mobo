...
class _UnpaidOrdersCheckScreenState extends State<UnpaidOrdersCheckScreen>
                                  ...
                                  children: [
                                    FxButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        await Get.to(() => WebViewExample(order.stripe_url));
                                        Utils.toast("Checking payment status.");
  ...
  Future<void> do_cancel_oder() async {
    ...
    RespondModel resp = RespondModel(await Utils.http_post("cancel-order", {
      "id": order.id,
    }));
    if (resp.code != 1) {
