...
import 'package:nudipu/models/NewsPost.dart';
...
class NewsPostScreen extends StatefulWidget {
  ...
  NewsPostScreen(this.item, {Key? key}) : super(key: key);

  @override
  _NewsPostScreenState createState() => _NewsPostScreenState(item);
}
...
class _NewsPostScreenState extends State<NewsPostScreen>
  ...
  _NewsPostScreenState(this.item);
                              ...
                              children: [
                                FxContainer(
                                  ...
                                  child: FxText.bodyLarge(
                                    "${item.post_category_text} ".toUpperCase(),
                                    color :Colors.white,
                                    fontWeight : 800,
                                  ),
                                ),
