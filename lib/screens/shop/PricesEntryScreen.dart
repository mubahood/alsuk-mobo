    ...
    if (_formKey.currentState?.saveAndValidate() ?? false) {
      ...
      setState(() {
        widget.selected.add(
          PriceModel()
            ..min_qty =
                Utils.int_parse(formValues['min_qty']?.toString() ?? '0')
            ..max_qty =
                Utils.int_parse(formValues['max_qty']?.toString() ?? '0')
                  ...
                  Expanded(
                    ...
                    child: FormBuilderTextField(
                      ...
                      decoration: CustomTheme.input_decoration(
                        ...
                        label_font_size: 8,
                        padding:
                            FxSpacing.symmetric(horizontal: 10, vertical: 5),
                      ),
                  ...
                  Expanded(
                    ...
                    child: FormBuilderTextField(
                      ...
                      validator: FormBuilderValidators.compose([
                        ...
                        FormBuilderValidators.min(min_qty + 1,
                    ...
                    onPressed: () {
                      setState(() {
                        ...
                        _formKey.currentState
                            ?.patchValue({'min_qty': min_qty.toString()});
                      });
                    },
                  ),
                );
