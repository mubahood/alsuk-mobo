...
class AccountVerificationScreen extends StatefulWidget {
  ...
  AccountVerificationScreen(this.userModel, {Key? key}) : super(key: key);

  @override
  AccountVerificationScreenState createState() =>
      AccountVerificationScreenState();
}

class AccountVerificationScreenState extends State<AccountVerificationScreen> {
  ...
  Future<void> submit_form() async {
    ...
    formDataMap = {
      ...
      'task': 'request_verification_code',
    };
    ...
    RespondModel resp = RespondModel(
        await Utils.http_post('account-verification', formDataMap));
    if (resp.code != 1) {
      is_loading = false;
  ...
  Future<void> reset_password() async {
    ...
    widget.userModel.complete_profile = 'Yes';
    await widget.userModel.save();
    setState(() {
      is_loading = false;
    });
    Utils.toast("Account verified successfully!");
    setState(() {});
    return;
  }
                  ...
                  child: password_reset_success
                      ? Column(
                          children: [
                            ...
                            FxText.bodyLarge(
                              "Your account has been verified successfully. You can now fully use our services!",
                              fontWeight: 400,
                      ...
                      FxText.titleLarge("Sign in"),*/
                                ...
                                FormBuilderTextField(
                                  ...
                                  onChanged: (value) {
                                    setState(() {
                                      widget.userModel.email = value.toString();
                                    });
                                  },
                                  readOnly: widget.userModel.email!.isNotEmpty,
